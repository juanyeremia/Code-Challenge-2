    ...
    <Center>     
      ...
      {/* Business Concept */}
          ...
          <Grid templateColumns={'repeat(2, 1fr)'} gap={6} borderBottom={'1px solid lightgray'} paddingBottom={'70px'}>
            ...
            <GridItem w={'100%'} >
              <Text mb={'10px'}><b><i>To create a better everyday life for many people</i></b>, this is the IKEA vision. Our business idea is <i>to offer a wide range of well-designed, functional home furnishing products at prices so low that as many people as possible will be able to afford them.</i></Text>
          ...
          <SimpleGrid minChildWidth={'500px'} mb={'70px'} spacingX={'40px'} spacingY={'40px'} ml={'20px'} mr={'20px'}>
            <Box bgColor={'#F4F5F4'} p={'30px'}>
              ...
              <Text p={'20px'}><i>I love IKEA! I have gone so many times this year after my big move. They have everything you need and the wear and tear is so long. The best quality for the best price truly. Every time I go I can not help but leave with so much more than I planned!</i></Text>
